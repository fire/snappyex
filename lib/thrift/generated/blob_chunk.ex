defmodule Thrift.Generated.BlobChunk do
  ...
  defmodule BinaryProtocol do
    ...
    def serialize(%Thrift.Generated.BlobChunk{
          chunk: chunk,
          last: last,
          lob_id: lob_id,
          offset: offset,
      ...
      [
        case chunk do
          nil ->
            raise(
              ...
              "Required field :chunk on Thrift.Generated.BlobChunk must not be nil"
            )
        ...
        case last do
          ...
          _ ->
            raise(
              Thrift.InvalidValueError,
              "Required boolean field :last on Thrift.Generated.BlobChunk must be true or false"
            )
        end,
        case lob_id do
          nil ->
