defmodule(Thrift.Generated.BlobChunk) do
  ...
  defmodule(BinaryProtocol) do
    ...
    def(deserialize(binary)) do
      deserialize(binary, %Thrift.Generated.BlobChunk{})
    end
    defp(deserialize(<<0, rest::binary>>, %Thrift.Generated.BlobChunk{} = acc)) do
      {acc, rest}
    end
    ...
    def(serialize(%Thrift.Generated.BlobChunk{chunk: chunk, last: last, lob_id: lob_id, offset: offset, total_length: total_length})) do
      [case(chunk) do
        nil ->
          raise(Thrift.InvalidValueException, "Required field :chunk on Thrift.Generated.BlobChunk must not be nil")
        _ ->
        ...
        true ->
          <<2, 2::16-signed, 1>>
        _ ->
          raise(Thrift.InvalidValueException, "Required boolean field :last on Thrift.Generated.BlobChunk must be true or false")
      end, case(lob_id) do
        nil ->
          <<>>
        _ ->
