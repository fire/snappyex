defmodule(Thrift.Generated.BlobChunk) do
  ...
  defmodule(BinaryProtocol) do
    ...
    def(serialize(%Thrift.Generated.BlobChunk{chunk: chunk, last: last, lob_id: lob_id, offset: offset, total_length: total_length})) do
      [case(chunk) do
        nil ->
          raise(Thrift.InvalidValueError, "Required field :chunk on Thrift.Generated.BlobChunk must not be nil")
        _ ->
        ...
        true ->
          <<2, 2::16-signed, 1>>
        _ ->
          raise(Thrift.InvalidValueError, "Required boolean field :last on Thrift.Generated.BlobChunk must be true or false")
      end, case(lob_id) do
        nil ->
          <<>>
        _ ->
