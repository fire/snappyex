defmodule Thrift.Generated.ClobChunk do
  ...
  defmodule BinaryProtocol do
    ...
    def deserialize(binary) do
      deserialize(binary, %Thrift.Generated.ClobChunk{})
    end

    defp deserialize(<<0, rest::binary>>, %Thrift.Generated.ClobChunk{} = acc) do
      {acc, rest}
    end
    ...
    def serialize(%Thrift.Generated.ClobChunk{
          chunk: chunk,
          last: last,
          lob_id: lob_id,
          offset: offset,
      ...
      [
        case chunk do
          nil ->
            raise(
              ...
              "Required field :chunk on Thrift.Generated.ClobChunk must not be nil"
            )
        ...
        case last do
          ...
          _ ->
            raise(
              Thrift.InvalidValueError,
              "Required boolean field :last on Thrift.Generated.ClobChunk must be true or false"
            )
        end,
        case lob_id do
          nil ->
