defmodule Thrift.Generated.ColumnDescriptor do
  ...
  defstruct(
    ...
    full_table_name: nil,
    updatable: nil,
    definitely_updatable: nil,
    nullable: nil,
    auto_increment: nil,
    parameter_in: nil,
    parameter_out: nil,
    element_types: nil,
    udt_type_and_class_name: nil
  )
  ...
  defmodule BinaryProtocol do
    ...
    def deserialize(binary) do
      deserialize(binary, %Thrift.Generated.ColumnDescriptor{})
    end

    defp deserialize(<<0, rest::binary>>, %Thrift.Generated.ColumnDescriptor{} = acc) do
      {acc, rest}
    end
    ...
    defp deserialize__element_types(<<element::32-signed, rest::binary>>, [
           list,
           remaining | stack
         ]) do
    ...
    def serialize(%Thrift.Generated.ColumnDescriptor{
          type: type,
          precision: precision,
          scale: scale,
          name: name,
          ...
          updatable: updatable,
          definitely_updatable: definitely_updatable,
          nullable: nullable,
          auto_increment: auto_increment,
          parameter_in: parameter_in,
          parameter_out: parameter_out,
          element_types: element_types,
          udt_type_and_class_name: udt_type_and_class_name
        }) do
      [
        case type do
          nil ->
            raise(
              ...
              "Required field :type on Thrift.Generated.ColumnDescriptor must not be nil"
            )
        ...
        case precision do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :precision on Thrift.Generated.ColumnDescriptor must not be nil"
            )
        ...
        case updatable do
          ...
          _ ->
            raise(
              Thrift.InvalidValueError,
              "Optional boolean field :updatable on Thrift.Generated.ColumnDescriptor must be true, false, or nil"
            )
        end,
        case definitely_updatable do
          nil ->
            <<>>
          ...
          _ ->
            raise(
              Thrift.InvalidValueError,
              "Optional boolean field :definitely_updatable on Thrift.Generated.ColumnDescriptor must be true, false, or nil"
            )
        end,
        case nullable do
          nil ->
          ...
          _ ->
            raise(
              Thrift.InvalidValueError,
              "Optional boolean field :nullable on Thrift.Generated.ColumnDescriptor must be true, false, or nil"
            )
        end,
        case auto_increment do
          nil ->
            <<>>
          ...
          _ ->
            raise(
              Thrift.InvalidValueError,
              "Optional boolean field :auto_increment on Thrift.Generated.ColumnDescriptor must be true, false, or nil"
            )
        end,
        case parameter_in do
          nil ->
            <<>>
          ...
          _ ->
            raise(
              Thrift.InvalidValueError,
              "Optional boolean field :parameter_in on Thrift.Generated.ColumnDescriptor must be true, false, or nil"
            )
        end,
        case parameter_out do
          nil ->
            <<>>
          ...
          _ ->
            raise(
              Thrift.InvalidValueError,
              "Optional boolean field :parameter_out on Thrift.Generated.ColumnDescriptor must be true, false, or nil"
            )
        end,
        case element_types do
          ...
          _ ->
            [
              <<15, 12::16-signed, 8, length(element_types)::32-signed>>
              | for e <- element_types do
                  <<e::32-signed>>
                end
            ]
        end,
        case udt_type_and_class_name do
          nil ->
            <<>>

          _ ->
            [
              <<11, 13::16-signed, byte_size(udt_type_and_class_name)::32-signed>>
              | udt_type_and_class_name
            ]
        end
        | <<0>>
      ]
