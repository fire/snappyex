defmodule Thrift.Generated.ColumnValue do
  ...
  defmodule BinaryProtocol do
    ...
    defp deserialize(
           <<11, 20::16-signed, string_size::32-signed, value::binary-size(string_size),
             rest::binary>>,
           acc
         ) do
    ...
    def serialize(%Thrift.Generated.ColumnValue{
      ...
      [
        <<15, 16::16-signed, 12, length(array_val)::32-signed>>,
        for e <- array_val do
    ...
    def serialize(%Thrift.Generated.ColumnValue{
      ...
      [
        <<13, 17::16-signed, 12, 12, Enum.count(map_val)::32-signed>>,
        for {k, v} <- map_val do
    ...
    def serialize(%Thrift.Generated.ColumnValue{
      ...
      [
        <<15, 18::16-signed, 12, length(struct_val)::32-signed>>,
        for e <- struct_val do
          Thrift.Generated.ColumnValue.serialize(e)
        end
        | <<0>>
