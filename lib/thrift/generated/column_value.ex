defmodule(Thrift.Generated.ColumnValue) do
  ...
  defmodule(BinaryProtocol) do
    ...
    def(deserialize(binary)) do
      deserialize(binary, %Thrift.Generated.ColumnValue{})
    end
    defp(deserialize(<<0, rest::binary>>, %Thrift.Generated.ColumnValue{} = acc)) do
      {acc, rest}
    end
    ...
    defp(deserialize(<<4, 7::16-signed, 0::1, 2047::11, 0::52, rest::binary>>, acc)) do
      deserialize(rest, %{acc | double_val: :inf})
    end
    defp(deserialize(<<4, 7::16-signed, 1::1, 2047::11, 0::52, rest::binary>>, acc)) do
      deserialize(rest, %{acc | double_val: :"-inf"})
    end
    defp(deserialize(<<4, 7::16-signed, sign::1, 2047::11, frac::52, rest::binary>>, acc)) do
      deserialize(rest, %{acc | double_val: %Thrift.NaN{sign: sign, fraction: frac}})
    end
    ...
    defp(deserialize(<<12, 9::16-signed, rest::binary>>, acc)) do
      case(Elixir.Thrift.Generated.Decimal.BinaryProtocol.deserialize(rest)) do
        {value, rest} ->
    ...
    def(serialize(%Thrift.Generated.ColumnValue{bool_val: nil, byte_val: nil, i16_val: nil, i32_val: nil, i64_val: nil, float_val: nil, double_val: double_val, string_val: nil, decimal_val: nil, date_val: nil, time_val: nil, timestamp_val: nil, binary_val: nil, blob_val: nil, clob_val: nil, array_val: nil, map_val: nil, struct_val: nil, null_val: nil, java_val: nil})) do
      [<<4, 7::16-signed>>, case(double_val) do
        :inf ->
          <<0::1, 2047::11, 0::52>>
        :"-inf" ->
          <<1::1, 2047::11, 0::52>>
    ...
    def(serialize(%Thrift.Generated.ColumnValue{bool_val: nil, byte_val: nil, i16_val: nil, i32_val: nil, i64_val: nil, float_val: nil, double_val: nil, string_val: nil, decimal_val: decimal_val, date_val: nil, time_val: nil, timestamp_val: nil, binary_val: nil, blob_val: nil, clob_val: nil, array_val: nil, map_val: nil, struct_val: nil, null_val: nil, java_val: nil})) do
      [<<12, 9::16-signed>>, Thrift.Generated.Decimal.serialize(decimal_val) | <<0>>]
    end
    ...
    def(serialize(%Thrift.Generated.ColumnValue{bool_val: nil, byte_val: nil, i16_val: nil, i32_val: nil, i64_val: nil, float_val: nil, double_val: nil, string_val: nil, decimal_val: nil, date_val: nil, time_val: nil, timestamp_val: nil, binary_val: nil, blob_val: blob_val, clob_val: nil, array_val: nil, map_val: nil, struct_val: nil, null_val: nil, java_val: nil})) do
      [<<12, 14::16-signed>>, Thrift.Generated.BlobChunk.serialize(blob_val) | <<0>>]
    end
    def(serialize(%Thrift.Generated.ColumnValue{bool_val: nil, byte_val: nil, i16_val: nil, i32_val: nil, i64_val: nil, float_val: nil, double_val: nil, string_val: nil, decimal_val: nil, date_val: nil, time_val: nil, timestamp_val: nil, binary_val: nil, blob_val: nil, clob_val: clob_val, array_val: nil, map_val: nil, struct_val: nil, null_val: nil, java_val: nil})) do
      [<<12, 15::16-signed>>, Thrift.Generated.ClobChunk.serialize(clob_val) | <<0>>]
    end
    ...
    def(serialize(%Thrift.Generated.ColumnValue{bool_val: nil, byte_val: nil, i16_val: nil, i32_val: nil, i64_val: nil, float_val: nil, double_val: nil, string_val: nil, decimal_val: nil, date_val: nil, time_val: nil, timestamp_val: nil, binary_val: nil, blob_val: nil, clob_val: nil, array_val: nil, map_val: map_val, struct_val: nil, null_val: nil, java_val: nil})) do
      [<<13, 17::16-signed, 12, 12, Enum.count(map_val)::32-signed>>, for({k, v} <- map_val) do
        [Thrift.Generated.ColumnValue.serialize(k) | Thrift.Generated.ColumnValue.serialize(v)]
      end | <<0>>]
    end
    ...
    def(serialize(%Thrift.Generated.ColumnValue{} = value)) do
