defmodule Thrift.Generated.HostAddress do
  ...
  defmodule BinaryProtocol do
    ...
    def deserialize(binary) do
      deserialize(binary, %Thrift.Generated.HostAddress{})
    end

    defp deserialize(<<0, rest::binary>>, %Thrift.Generated.HostAddress{} = acc) do
      {acc, rest}
    end
    ...
    def serialize(%Thrift.Generated.HostAddress{
          host_name: host_name,
          port: port,
      ...
      [
        case host_name do
          nil ->
            raise(
              ...
              "Required field :host_name on Thrift.Generated.HostAddress must not be nil"
            )
        ...
        case port do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :port on Thrift.Generated.HostAddress must not be nil"
            )
