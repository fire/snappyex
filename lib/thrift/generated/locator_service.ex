defmodule(Thrift.Generated.LocatorService) do
  ...
  defmodule(Binary.Framed.Server) do
    ...
    def(handle_thrift("getAllServersWithPreferredServer", binary_data, handler_module)) do
      case(Elixir.Thrift.Generated.LocatorService.GetAllServersWithPreferredServerArgs.BinaryProtocol.deserialize(binary_data)) do
        {%Thrift.Generated.LocatorService.GetAllServersWithPreferredServerArgs{server_types: server_types, server_groups: server_groups, failed_servers: failed_servers}, ""} ->
          try() do
            rsp = handler_module.get_all_servers_with_preferred_server(server_types, server_groups, failed_servers)
            (
              response = %Thrift.Generated.LocatorService.GetAllServersWithPreferredServerResponse{success: rsp}
              {:reply, Elixir.Thrift.Generated.LocatorService.GetAllServersWithPreferredServerResponse.BinaryProtocol.serialize(response)}
            )
          rescue
            error in Thrift.Generated.SnappyException ->
              response = %Thrift.Generated.LocatorService.GetAllServersWithPreferredServerResponse{error: error}
              {:reply, Elixir.Thrift.Generated.LocatorService.GetAllServersWithPreferredServerResponse.BinaryProtocol.serialize(response)}
          catch
            kind, reason ->
    ...
    def(handle_thrift("getPreferredServer", binary_data, handler_module)) do
      case(Elixir.Thrift.Generated.LocatorService.GetPreferredServerArgs.BinaryProtocol.deserialize(binary_data)) do
        {%Thrift.Generated.LocatorService.GetPreferredServerArgs{server_types: server_types, server_groups: server_groups, failed_servers: failed_servers}, ""} ->
          try() do
            ...
            (
              ...
              {:reply, Elixir.Thrift.Generated.LocatorService.GetPreferredServerResponse.BinaryProtocol.serialize(response)}
            )
          rescue
            error in Thrift.Generated.SnappyException ->
