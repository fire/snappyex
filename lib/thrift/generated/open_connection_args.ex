defmodule Thrift.Generated.OpenConnectionArgs do
  ...
  defmodule BinaryProtocol do
    ...
    def deserialize(binary) do
      deserialize(binary, %Thrift.Generated.OpenConnectionArgs{})
    end

    defp deserialize(<<0, rest::binary>>, %Thrift.Generated.OpenConnectionArgs{} = acc) do
      {acc, rest}
    end
    ...
    defp deserialize__properties__key(
    ...
    defp deserialize__properties__value(
    ...
    def serialize(%Thrift.Generated.OpenConnectionArgs{
      ...
      [
        case client_host_name do
          nil ->
            raise(
              ...
              "Required field :client_host_name on Thrift.Generated.OpenConnectionArgs must not be nil"
            )
        ...
        case client_id do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :client_id on Thrift.Generated.OpenConnectionArgs must not be nil"
            )
        ...
        case security do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :security on Thrift.Generated.OpenConnectionArgs must not be nil"
            )
        ...
        case for_xa do
          ...
          _ ->
            raise(
              Thrift.InvalidValueError,
              "Optional boolean field :for_xa on Thrift.Generated.OpenConnectionArgs must be true, false, or nil"
            )
        end,
        case token_size do
          nil ->
        ...
        case use_string_for_decimal do
          nil ->
            <<>>
          ...
          _ ->
            raise(
              Thrift.InvalidValueError,
              "Optional boolean field :use_string_for_decimal on Thrift.Generated.OpenConnectionArgs must be true, false, or nil"
            )
        end,
        case properties do
          nil ->
          ...
          _ ->
            [
              <<13, 9::16-signed, 11, 11, Enum.count(properties)::32-signed>>
