defmodule Thrift.Generated.PrepareResult do
  ...
  defstruct(
    statement_id: nil,
    statement_type: nil,
    parameter_meta_data: nil,
    result_set_meta_data: nil,
    warnings: nil
  )
  ...
  defmodule BinaryProtocol do
    ...
    def serialize(%Thrift.Generated.PrepareResult{
          statement_id: statement_id,
          statement_type: statement_type,
          parameter_meta_data: parameter_meta_data,
          result_set_meta_data: result_set_meta_data,
          warnings: warnings
        }) do
      [
        case statement_id do
          nil ->
            raise(
              ...
              "Required field :statement_id on Thrift.Generated.PrepareResult must not be nil"
            )
        ...
        case statement_type do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :statement_type on Thrift.Generated.PrepareResult must not be nil"
            )

          _ ->
            <<3, 2::16-signed, statement_type::8-signed>>
        end,
        case parameter_meta_data do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :parameter_meta_data on Thrift.Generated.PrepareResult must not be nil"
            )

          _ ->
            [
              <<15, 3::16-signed, 12, length(parameter_meta_data)::32-signed>>
              | for e <- parameter_meta_data do
                  Thrift.Generated.ColumnDescriptor.serialize(e)
                end
            ]
        end,
        case result_set_meta_data do
          nil ->
            <<>>

          _ ->
            [
              <<15, 4::16-signed, 12, length(result_set_meta_data)::32-signed>>
              | for e <- result_set_meta_data do
                  Thrift.Generated.ColumnDescriptor.serialize(e)
                end
            ]
        end,
