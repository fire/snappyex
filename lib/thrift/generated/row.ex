defmodule Thrift.Generated.Row do
  ...
  defmodule BinaryProtocol do
    ...
    def deserialize(binary) do
      deserialize(binary, %Thrift.Generated.Row{})
    end

    defp deserialize(<<0, rest::binary>>, %Thrift.Generated.Row{} = acc) do
      {acc, rest}
    end
        ...
        case values do
          nil ->
            raise(
              ...
              "Required field :values on Thrift.Generated.Row must not be nil"
            )

          _ ->
            [
              <<15, 1::16-signed, 12, length(values)::32-signed>>
              | for e <- values do
