defmodule Thrift.Generated.ServiceMetaDataArgs do
  ...
  defmodule BinaryProtocol do
    ...
    def deserialize(binary) do
      deserialize(binary, %Thrift.Generated.ServiceMetaDataArgs{})
    end

    defp deserialize(<<0, rest::binary>>, %Thrift.Generated.ServiceMetaDataArgs{} = acc) do
      {acc, rest}
    end
    ...
    defp deserialize(
           <<11, 8::16-signed, string_size::32-signed, value::binary-size(string_size),
             rest::binary>>,
           acc
         ) do
    ...
    defp deserialize(
           <<11, 9::16-signed, string_size::32-signed, value::binary-size(string_size),
             rest::binary>>,
           acc
         ) do
    ...
    defp deserialize(
           <<11, 11::16-signed, string_size::32-signed, value::binary-size(string_size),
             rest::binary>>,
           acc
         ) do
    ...
    defp deserialize(
           <<11, 12::16-signed, string_size::32-signed, value::binary-size(string_size),
             rest::binary>>,
           acc
         ) do
    ...
    def serialize(%Thrift.Generated.ServiceMetaDataArgs{
          conn_id: conn_id,
      ...
      [
        case conn_id do
          nil ->
            raise(
              ...
              "Required field :conn_id on Thrift.Generated.ServiceMetaDataArgs must not be nil"
            )
        ...
        case driver_type do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :driver_type on Thrift.Generated.ServiceMetaDataArgs must not be nil"
            )
        ...
        case token do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :token on Thrift.Generated.ServiceMetaDataArgs must not be nil"
            )
        ...
        case table_types do
          ...
          _ ->
            [
              <<15, 6::16-signed, 11, length(table_types)::32-signed>>
              | for e <- table_types do
