defmodule Thrift.Generated.SnappyDataService do
  ...
  defmodule GetClobChunkArgs do
    ...
    defmodule BinaryProtocol do
      ...
      def serialize(%GetClobChunkArgs{
            conn_id: conn_id,
            lob_id: lob_id,
            offset: offset,
            size: size,
            free_lob_at_end: free_lob_at_end,
            token: token
          }) do
        [
          case conn_id do
          ...
          case free_lob_at_end do
            ...
            _ ->
              raise(
                ...
                "Optional boolean field :free_lob_at_end on GetClobChunkArgs must be true, false, or nil"
              )
          end,
          case token do
            nil ->
  ...
  defmodule BeginTransactionArgs do
    ...
    defmodule BinaryProtocol do
      ...
      def serialize(%BeginTransactionArgs{
            conn_id: conn_id,
        ...
        [
          ...
          case flags do
            ...
            _ ->
              [
                <<13, 3::16-signed, 8, 2, Enum.count(flags)::32-signed>>
                | for {k, v} <- flags do
                    [
                      <<k::32-signed>>
                      | case v do
  ...
  defmodule RollbackTransactionArgs do
    ...
    defmodule BinaryProtocol do
      ...
      def serialize(%RollbackTransactionArgs{
            conn_id: conn_id,
        ...
        [
          ...
          case start_new_transaction do
            ...
            _ ->
              raise(
                Thrift.InvalidValueError,
                "Optional boolean field :start_new_transaction on RollbackTransactionArgs must be true, false, or nil"
              )
          end,
          case flags do
            nil ->
  ...
  defmodule ExecutePreparedUpdateArgs do
    ...
    defmodule BinaryProtocol do
      ...
      def serialize(%ExecutePreparedUpdateArgs{
            stmt_id: stmt_id,
            params: params,
            attrs: attrs,
            token: token
  ...
  defmodule GetBlobChunkArgs do
    ...
    defmodule BinaryProtocol do
      ...
      def serialize(%GetBlobChunkArgs{
            conn_id: conn_id,
            lob_id: lob_id,
            offset: offset,
            size: size,
        ...
        [
          ...
          case free_lob_at_end do
            ...
            _ ->
              raise(
                Thrift.InvalidValueError,
                "Optional boolean field :free_lob_at_end on GetBlobChunkArgs must be true, false, or nil"
              )
          end,
          case token do
            nil ->
  ...
  defmodule StartXATransactionArgs do
    ...
    defmodule BinaryProtocol do
      ...
      def serialize(%StartXATransactionArgs{
            conn_id: conn_id,
            xid: xid,
        ...
        [
          case metadata_args do
            ...
            _ ->
              [
                <<12, 1::16-signed>>
                | Thrift.Generated.ServiceMetaDataArgs.serialize(metadata_args)
              ]
          end,
          case types do
            nil ->
            ...
            _ ->
              [
                <<15, 2::16-signed, 8, length(types)::32-signed>>
                | for e <- types do
                    <<e::32-signed>>
                  end
              ]
  ...
  defmodule ExecutePreparedQueryArgs do
    ...
    defmodule BinaryProtocol do
      ...
      def serialize(%ExecutePreparedQueryArgs{
            stmt_id: stmt_id,
            params: params,
            attrs: attrs,
            token: token
      ...
      def serialize(%BulkCloseArgs{entities: entities}) do
        [
          case entities do
            ...
            _ ->
              [
                <<15, 1::16-signed, 12, length(entities)::32-signed>>
                | for e <- entities do
    ...
    defmodule BinaryProtocol do
      ...
      defp deserialize__output_params__value(<<rest::binary>>, key, [map, remaining | stack]) do
        case Elixir.Thrift.Generated.OutputParameter.BinaryProtocol.deserialize(rest) do
          {value, rest} ->
            deserialize__output_params__key(rest, [
      ...
      def serialize(%PrepareStatementArgs{
            conn_id: conn_id,
            sql: sql,
        ...
        [
          ...
          case output_params do
            ...
            _ ->
              [
                <<13, 3::16-signed, 8, 12, Enum.count(output_params)::32-signed>>
                | for {k, v} <- output_params do
  ...
  defmodule CommitXATransactionArgs do
    ...
    defmodule BinaryProtocol do
      ...
      def serialize(%CommitXATransactionArgs{
            conn_id: conn_id,
            xid: xid,
            one_phase: one_phase,
            token: token
        ...
        [
          ...
          case one_phase do
            ...
            _ ->
              raise(
                Thrift.InvalidValueError,
                "Optional boolean field :one_phase on CommitXATransactionArgs must be true, false, or nil"
              )
          end,
          case token do
            nil ->
  ...
  defmodule ExecuteCursorUpdateArgs do
    ...
    defstruct(
      ...
      operations: nil,
      changed_rows: nil,
      changed_columns_list: nil,
      changed_row_indexes: nil,
      token: nil
    )
    ...
    defmodule BinaryProtocol do
      ...
      defp deserialize__changed_columns_list(<<8, inner_remaining::32-signed, rest::binary>>, [
             list,
             remaining | stack
           ]) do
        deserialize__changed_columns_list__element(rest, [
          [],
          inner_remaining,
          list,
          remaining | stack
      ...
      defp deserialize__changed_columns_list__element(<<rest::binary>>, [
             inner_list,
             0,
             list,
             remaining | stack
           ]) do
        deserialize__changed_columns_list(rest, [
          [Enum.reverse(inner_list) | list],
          remaining - 1 | stack
        ])
      end

      defp deserialize__changed_columns_list__element(<<element::32-signed, rest::binary>>, [
             list,
             remaining | stack
           ]) do
      ...
      defp deserialize__changed_row_indexes(<<element::32-signed, rest::binary>>, [
             list,
             remaining | stack
           ]) do
      ...
      def serialize(%ExecuteCursorUpdateArgs{
            cursor_id: cursor_id,
            operations: operations,
            changed_rows: changed_rows,
            changed_columns_list: changed_columns_list,
            changed_row_indexes: changed_row_indexes,
            token: token
          }) do
        [
          case cursor_id do
          ...
          case operations do
            ...
            _ ->
              [
                <<15, 2::16-signed, 8, length(operations)::32-signed>>
                | for e <- operations do
                    <<e::32-signed>>
                  end
              ]
          end,
          case changed_rows do
            nil ->
              <<>>

            _ ->
              [
                <<15, 3::16-signed, 12, length(changed_rows)::32-signed>>
                | for e <- changed_rows do
                    Thrift.Generated.Row.serialize(e)
                  end
              ]
          end,
          case changed_columns_list do
            nil ->
              <<>>

            _ ->
              [
                <<15, 4::16-signed, 15, length(changed_columns_list)::32-signed>>
                | for e <- changed_columns_list do
                    [
                      <<8, length(e)::32-signed>>
                      | for e <- e do
                          <<e::32-signed>>
                        end
                    ]
          ...
          case changed_row_indexes do
            nil ->
              <<>>

            _ ->
              [
                <<15, 5::16-signed, 8, length(changed_row_indexes)::32-signed>>
                | for e <- changed_row_indexes do
                    <<e::32-signed>>
                  end
              ]
          end,
      ...
      def serialize(%SetTransactionAttributesArgs{conn_id: conn_id, flags: flags, token: token}) do
        [
          ...
          case flags do
            ...
            _ ->
              [
                <<13, 2::16-signed, 8, 2, Enum.count(flags)::32-signed>>
                | for {k, v} <- flags do
                    [
                      <<k::32-signed>>
                      | case v do
  ...
  defmodule ExecutePreparedBatchArgs do
    ...
    defmodule BinaryProtocol do
      ...
      def serialize(%ExecutePreparedBatchArgs{
            stmt_id: stmt_id,
        ...
        [
          ...
          case params_batch do
            nil ->
              <<>>

            _ ->
              [
                <<15, 2::16-signed, 12, length(params_batch)::32-signed>>
                | for e <- params_batch do
                    Thrift.Generated.Row.serialize(e)
                  end
              ]
          end,
  ...
  defmodule GetNextResultSetArgs do
    ...
    defmodule BinaryProtocol do
      ...
      def serialize(%GetNextResultSetArgs{
            cursor_id: cursor_id,
            other_result_set_behaviour: other_result_set_behaviour,
            token: token
          }) do
        [
          case cursor_id do
          ...
          case other_result_set_behaviour do
            nil ->
              <<>>
  ...
  defmodule CloseConnectionArgs do
    ...
    defmodule BinaryProtocol do
      ...
      def serialize(%CloseConnectionArgs{
            conn_id: conn_id,
        ...
        [
          ...
          case close_socket do
            ...
            _ ->
              raise(
                Thrift.InvalidValueError,
                "Optional boolean field :close_socket on CloseConnectionArgs must be true, false, or nil"
              )
          end,
          case token do
            nil ->
  ...
  defmodule ExecutePreparedArgs do
    ...
    defmodule BinaryProtocol do
      ...
      def serialize(%ExecutePreparedArgs{
            stmt_id: stmt_id,
            params: params,
            output_params: output_params,
            attrs: attrs,
  ...
  defmodule CommitTransactionArgs do
    ...
    defmodule BinaryProtocol do
      ...
      def serialize(%CommitTransactionArgs{
            conn_id: conn_id,
            start_new_transaction: start_new_transaction,
            flags: flags,
            token: token
        ...
        [
          ...
          case start_new_transaction do
            ...
            _ ->
              raise(
                Thrift.InvalidValueError,
                "Optional boolean field :start_new_transaction on CommitTransactionArgs must be true, false, or nil"
              )
          end,
          case flags do
            nil ->
  ...
  defmodule PrepareAndExecuteArgs do
    ...
    defmodule BinaryProtocol do
      ...
      def serialize(%PrepareAndExecuteArgs{
            conn_id: conn_id,
            sql: sql,
            params_batch: params_batch,
            output_params: output_params,
        ...
        [
          ...
          case params_batch do
            ...
            _ ->
              [
                <<15, 3::16-signed, 12, length(params_batch)::32-signed>>
                | for e <- params_batch do
                    Thrift.Generated.Row.serialize(e)
                  end
              ]
          ...
          case output_params do
            ...
            _ ->
              [
                <<13, 4::16-signed, 8, 12, Enum.count(output_params)::32-signed>>
                | for {k, v} <- output_params do
                    [<<k::32-signed>> | Thrift.Generated.OutputParameter.serialize(v)]
                  end
              ]
  ...
  defmodule GetIndexInfoArgs do
    ...
    defmodule BinaryProtocol do
      ...
      def serialize(%GetIndexInfoArgs{
        ...
        [
          ...
          case unique do
            ...
            _ ->
              raise(
                Thrift.InvalidValueError,
                "Optional boolean field :unique on GetIndexInfoArgs must be true, false, or nil"
              )
          end,
          case approximate do
            nil ->
            ...
            _ ->
              raise(
                Thrift.InvalidValueError,
                "Optional boolean field :approximate on GetIndexInfoArgs must be true, false, or nil"
              )
          end
          | <<0>>
        ]
  ...
  defmodule ScrollCursorArgs do
    ...
    defmodule BinaryProtocol do
      ...
      def serialize(%ScrollCursorArgs{
            cursor_id: cursor_id,
            offset: offset,
            offset_is_absolute: offset_is_absolute,
        ...
        [
          ...
          case offset_is_absolute do
            ...
            _ ->
              raise(
                Thrift.InvalidValueError,
                "Optional boolean field :offset_is_absolute on ScrollCursorArgs must be true, false, or nil"
              )
          end,
          case fetch_reverse do
            nil ->
              <<>>
            ...
            _ ->
              raise(
                Thrift.InvalidValueError,
                "Optional boolean field :fetch_reverse on ScrollCursorArgs must be true, false, or nil"
              )
          end,
          case fetch_size do
            nil ->
      ...
      def serialize(%ExecuteUpdateArgs{conn_id: conn_id, sqls: sqls, attrs: attrs, token: token}) do
        [
          ...
          case sqls do
            ...
            _ ->
              [
                <<15, 2::16-signed, 11, length(sqls)::32-signed>>
                | for e <- sqls do
                    [<<byte_size(e)::32-signed>> | e]
                  end
              ]
  ...
  defmodule GetBestRowIdentifierArgs do
    ...
    defmodule BinaryProtocol do
      ...
      def serialize(%GetBestRowIdentifierArgs{
            metadata_args: metadata_args,
            scope: scope,
            nullable: nullable
          }) do
        [
          ...
          case nullable do
            ...
            _ ->
              raise(
                Thrift.InvalidValueError,
                "Optional boolean field :nullable on GetBestRowIdentifierArgs must be true, false, or nil"
              )
          end
          | <<0>>
        ]
  ...
  defmodule FetchActiveStatementsResponse do
    ...
    defmodule BinaryProtocol do
      ...
      defp deserialize__success__value(
      ...
      def serialize(%FetchActiveStatementsResponse{success: success, error: error}) do
        [
          case success do
            ...
            _ ->
              [
                <<13, 0::16-signed, 10, 11, Enum.count(success)::32-signed>>
                | for {k, v} <- success do
      ...
      def serialize(%GetTransactionAttributesResponse{success: success, error: error}) do
        [
          case success do
            ...
            _ ->
              [
                <<13, 0::16-signed, 8, 2, Enum.count(success)::32-signed>>
                | for {k, v} <- success do
                    [
                      <<k::32-signed>>
                      | case v do
  ...
  defmodule Binary.Framed.Client do
    ...
    def unquote(:cancel_statement)(client, stmt_id, token, rpc_opts \\ []) do
      ...
      ClientImpl.call(
        ...
        "cancelStatement",
        serialized_args,
        CancelStatementResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:get_clob_chunk)(
      ...
      ClientImpl.call(
        ...
        "getClobChunk",
        serialized_args,
        GetClobChunkResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:recover_xa_transaction)(client, conn_id, flag, token, rpc_opts \\ []) do
      ...
      ClientImpl.call(
        client,
        "recoverXATransaction",
        serialized_args,
        RecoverXATransactionResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:begin_transaction)(
      ...
      ClientImpl.call(
        ...
        "beginTransaction",
        serialized_args,
        BeginTransactionResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:rollback_transaction)(
          client,
          conn_id,
      ...
      ClientImpl.call(
        ...
        "rollbackTransaction",
        serialized_args,
        RollbackTransactionResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:rollback_transaction!)(
      ...
      case unquote(:rollback_transaction)(
             client,
             conn_id,
             start_new_transaction,
             flags,
    ...
    def unquote(:execute_prepared_update)(client, stmt_id, params, attrs, token, rpc_opts \\ []) do
      args = %ExecutePreparedUpdateArgs{
        stmt_id: stmt_id,
        params: params,
        attrs: attrs,
        token: token
      ...
      ClientImpl.call(
        ...
        serialized_args,
        ExecutePreparedUpdateResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:fetch_active_statements)(client, conn_id, token, rpc_opts \\ []) do
      ...
      ClientImpl.call(
        ...
        serialized_args,
        FetchActiveStatementsResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:open_connection)(client, arguments, rpc_opts \\ []) do
      ...
      ClientImpl.call(
        ...
        "openConnection",
        serialized_args,
        OpenConnectionResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:get_blob_chunk)(
      ...
      ClientImpl.call(
        ...
        "getBlobChunk",
        serialized_args,
        GetBlobChunkResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:start_xa_transaction)(
          client,
          conn_id,
          xid,
          timeout_in_seconds,
      ...
      ClientImpl.call(
        ...
        "startXATransaction",
        serialized_args,
        StartXATransactionResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:start_xa_transaction!)(
      ...
      case unquote(:start_xa_transaction)(
             client,
             conn_id,
             xid,
             timeout_in_seconds,
    ...
    def unquote(:get_ud_ts)(client, metadata_args, types, rpc_opts \\ []) do
      ...
      ClientImpl.call(
        ...
        "getUDTs",
        serialized_args,
        GetUDTsResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:get_service_meta_data)(client, conn_id, token, rpc_opts \\ []) do
      ...
      ClientImpl.call(
        ...
        "getServiceMetaData",
        serialized_args,
        GetServiceMetaDataResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:prepare_xa_transaction)(client, conn_id, xid, token, rpc_opts \\ []) do
      ...
      ClientImpl.call(
        ...
        serialized_args,
        PrepareXATransactionResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:execute_prepared_query)(client, stmt_id, params, attrs, token, rpc_opts \\ []) do
      ...
      ClientImpl.call(
        ...
        serialized_args,
        ExecutePreparedQueryResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:send_blob_chunk)(client, chunk, conn_id, token, rpc_opts \\ []) do
      ...
      ClientImpl.call(
        ...
        "sendBlobChunk",
        serialized_args,
        SendBlobChunkResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:end_xa_transaction)(client, conn_id, xid, flags, token, rpc_opts \\ []) do
      ...
      ClientImpl.call(
        ...
        "endXATransaction",
        serialized_args,
        EndXATransactionResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:rollback_xa_transaction)(client, conn_id, xid, token, rpc_opts \\ []) do
      ...
      ClientImpl.call(
        ...
        serialized_args,
        RollbackXATransactionResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:prepare_statement)(
      ...
      ClientImpl.call(
        ...
        "prepareStatement",
        serialized_args,
        PrepareStatementResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:prepare_statement!)(
      ...
      case unquote(:prepare_statement)(
             client,
             conn_id,
             sql,
             output_params,
    ...
    def unquote(:commit_xa_transaction)(client, conn_id, xid, one_phase, token, rpc_opts \\ []) do
      ...
      ClientImpl.call(
        ...
        "commitXATransaction",
        serialized_args,
        CommitXATransactionResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:execute_cursor_update)(
          client,
          cursor_id,
          operations,
          changed_rows,
      ...
      ClientImpl.call(
        ...
        "executeCursorUpdate",
        serialized_args,
        ExecuteCursorUpdateResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:execute_cursor_update!)(
      ...
      case unquote(:execute_cursor_update)(
             client,
             cursor_id,
             operations,
             changed_rows,
    ...
    def unquote(:set_transaction_attributes)(client, conn_id, flags, token, rpc_opts \\ []) do
      ...
      ClientImpl.call(
        ...
        serialized_args,
        SetTransactionAttributesResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:execute_prepared_batch)(
          client,
          stmt_id,
          params_batch,
          attrs,
      ...
      ClientImpl.call(
        ...
        serialized_args,
        ExecutePreparedBatchResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:free_lob)(client, conn_id, lob_id, token, rpc_opts \\ []) do
      ...
      ClientImpl.call(
        ...
        "freeLob",
        serialized_args,
        FreeLobResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:get_next_result_set)(
          client,
          cursor_id,
          other_result_set_behaviour,
          token,
          rpc_opts \\ []
        ) do
      args = %GetNextResultSetArgs{
        cursor_id: cursor_id,
        other_result_set_behaviour: other_result_set_behaviour,
        token: token
      }
      ...
      ClientImpl.call(
        ...
        "getNextResultSet",
        serialized_args,
        GetNextResultSetResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:get_next_result_set!)(
      ...
      case unquote(:get_next_result_set)(
             client,
             cursor_id,
             other_result_set_behaviour,
             token,
    ...
    def unquote(:fetch_active_connections)(client, conn_id, token, rpc_opts \\ []) do
      ...
      ClientImpl.call(
        ...
        serialized_args,
        FetchActiveConnectionsResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:execute)(client, conn_id, sql, output_params, attrs, token, rpc_opts \\ []) do
      ...
      ClientImpl.call(
        ...
        "execute",
        serialized_args,
        ExecuteResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:execute_query)(client, conn_id, sql, attrs, token, rpc_opts \\ []) do
      ...
      ClientImpl.call(
        ...
        "executeQuery",
        serialized_args,
        ExecuteQueryResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:get_transaction_attributes)(client, conn_id, token, rpc_opts \\ []) do
      ...
      ClientImpl.call(
        ...
        serialized_args,
        GetTransactionAttributesResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:send_clob_chunk)(client, chunk, conn_id, token, rpc_opts \\ []) do
      ...
      ClientImpl.call(
        ...
        "sendClobChunk",
        serialized_args,
        SendClobChunkResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:close_result_set)(client, cursor_id, token, rpc_opts \\ []) do
      ...
      ClientImpl.call(
        ...
        "closeResultSet",
        serialized_args,
        CloseResultSetResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:execute_prepared)(
      ...
      ClientImpl.call(
        ...
        "executePrepared",
        serialized_args,
        ExecutePreparedResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:close_statement)(client, stmt_id, token, rpc_opts \\ []) do
      ...
      ClientImpl.call(
        ...
        "closeStatement",
        serialized_args,
        CloseStatementResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:commit_transaction)(
          client,
          conn_id,
          start_new_transaction,
          flags,
      ...
      ClientImpl.call(
        ...
        "commitTransaction",
        serialized_args,
        CommitTransactionResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:commit_transaction!)(
      ...
      case unquote(:commit_transaction)(
             client,
             conn_id,
             start_new_transaction,
             flags,
    ...
    def unquote(:prepare_and_execute)(
          client,
          conn_id,
          sql,
          params_batch,
      ...
      ClientImpl.call(
        ...
        "prepareAndExecute",
        serialized_args,
        PrepareAndExecuteResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:prepare_and_execute!)(
      ...
      case unquote(:prepare_and_execute)(
             client,
             conn_id,
             sql,
             params_batch,
    ...
    def unquote(:forget_xa_transaction)(client, conn_id, xid, token, rpc_opts \\ []) do
      ...
      ClientImpl.call(
        ...
        "forgetXATransaction",
        serialized_args,
        ForgetXATransactionResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:get_index_info)(client, metadata_args, unique, approximate, rpc_opts \\ []) do
      ...
      ClientImpl.call(
        ...
        "getIndexInfo",
        serialized_args,
        GetIndexInfoResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:scroll_cursor)(
      ...
      ClientImpl.call(
        ...
        "scrollCursor",
        serialized_args,
        ScrollCursorResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:execute_update)(client, conn_id, sqls, attrs, token, rpc_opts \\ []) do
      ...
      ClientImpl.call(
        ...
        "executeUpdate",
        serialized_args,
        ExecuteUpdateResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:get_best_row_identifier)(client, metadata_args, scope, nullable, rpc_opts \\ []) do
      ...
      ClientImpl.call(
        ...
        serialized_args,
        GetBestRowIdentifierResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:cancel_current_statement)(client, conn_id, token, rpc_opts \\ []) do
      ...
      ClientImpl.call(
        client,
        "cancelCurrentStatement",
        serialized_args,
        CancelCurrentStatementResponse.BinaryProtocol,
        rpc_opts
      )
    end
    ...
    def unquote(:get_schema_meta_data)(client, schema_call, metadata_args, rpc_opts \\ []) do
      ...
      ClientImpl.call(
        ...
        "getSchemaMetaData",
        serialized_args,
        GetSchemaMetaDataResponse.BinaryProtocol,
        rpc_opts
      )
    end
  ...
  defmodule Binary.Framed.Server do
    ...
    def handle_thrift("getPreferredServer", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.GetPreferredServerArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.GetPreferredServerArgs{
           server_types: server_types,
           server_groups: server_groups,
           failed_servers: failed_servers
         }, ""} ->
          try do
            ...
            (
              response = %Thrift.Generated.SnappyDataService.GetPreferredServerResponse{
                success: rsp
              }

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.GetPreferredServerResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("cancelStatement", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.CancelStatementArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
         ...
         ""} ->
          try do
            ...
            error in Thrift.Generated.SnappyException ->
              ...
              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.CancelStatementResponse.BinaryProtocol.serialize(
                 response
               )}
          end
    ...
    def handle_thrift("getClobChunk", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.GetClobChunkArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.GetClobChunkArgs{
           conn_id: conn_id,
           lob_id: lob_id,
           offset: offset,
           size: size,
          ...
          try do
            rsp =
              handler_module.get_clob_chunk(conn_id, lob_id, offset, size, free_lob_at_end, token)

            (
              response = %Thrift.Generated.SnappyDataService.GetClobChunkResponse{success: rsp}

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.GetClobChunkResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("recoverXATransaction", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.RecoverXATransactionArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.RecoverXATransactionArgs{
           conn_id: conn_id,
           flag: flag,
           token: token
         }, ""} ->
          try do
            ...
            (
              response = %Thrift.Generated.SnappyDataService.RecoverXATransactionResponse{
                success: rsp
              }

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.RecoverXATransactionResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("beginTransaction", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.BeginTransactionArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.BeginTransactionArgs{
           conn_id: conn_id,
           isolation_level: isolation_level,
           flags: flags,
           token: token
          ...
          try do
            ...
            (
              response = %Thrift.Generated.SnappyDataService.BeginTransactionResponse{
                success: rsp
              }

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.BeginTransactionResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("rollbackTransaction", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.RollbackTransactionArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.RollbackTransactionArgs{
           conn_id: conn_id,
           start_new_transaction: start_new_transaction,
           flags: flags,
           token: token
          ...
          try do
            rsp =
              handler_module.rollback_transaction(conn_id, start_new_transaction, flags, token)
            ...
            error in Thrift.Generated.SnappyException ->
              response = %Thrift.Generated.SnappyDataService.RollbackTransactionResponse{
                error: error
              }

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.RollbackTransactionResponse.BinaryProtocol.serialize(
                 response
               )}
          end
    ...
    def handle_thrift("executePreparedUpdate", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.ExecutePreparedUpdateArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.ExecutePreparedUpdateArgs{
           stmt_id: stmt_id,
           params: params,
           attrs: attrs,
           token: token
          ...
          try do
            ...
            (
              response = %Thrift.Generated.SnappyDataService.ExecutePreparedUpdateResponse{
                success: rsp
              }

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.ExecutePreparedUpdateResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("fetchActiveStatements", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.FetchActiveStatementsArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.FetchActiveStatementsArgs{
           conn_id: conn_id,
           token: token
         }, ""} ->
          try do
            ...
            (
              response = %Thrift.Generated.SnappyDataService.FetchActiveStatementsResponse{
                success: rsp
              }

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.FetchActiveStatementsResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("openConnection", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.OpenConnectionArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.OpenConnectionArgs{arguments: arguments}, ""} ->
          try do
            ...
            (
              ...
              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.OpenConnectionResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("getBlobChunk", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.GetBlobChunkArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.GetBlobChunkArgs{
           conn_id: conn_id,
           lob_id: lob_id,
           offset: offset,
           size: size,
          ...
          try do
            rsp =
              handler_module.get_blob_chunk(conn_id, lob_id, offset, size, free_lob_at_end, token)

            (
              response = %Thrift.Generated.SnappyDataService.GetBlobChunkResponse{success: rsp}

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.GetBlobChunkResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("startXATransaction", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.StartXATransactionArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.StartXATransactionArgs{
           conn_id: conn_id,
           xid: xid,
           timeout_in_seconds: timeout_in_seconds,
           flags: flags,
          ...
          try do
            rsp =
              handler_module.start_xa_transaction(conn_id, xid, timeout_in_seconds, flags, token)
            ...
            error in Thrift.Generated.SnappyException ->
              response = %Thrift.Generated.SnappyDataService.StartXATransactionResponse{
                error: error
              }

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.StartXATransactionResponse.BinaryProtocol.serialize(
                 response
               )}
          end
    ...
    def handle_thrift("getUDTs", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.GetUDTsArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.GetUDTsArgs{
           metadata_args: metadata_args,
           types: types
         }, ""} ->
          try do
            ...
            (
              ...
              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.GetUDTsResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("getServiceMetaData", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.GetServiceMetaDataArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.GetServiceMetaDataArgs{
           conn_id: conn_id,
           token: token
         }, ""} ->
          try do
            ...
            (
              response = %Thrift.Generated.SnappyDataService.GetServiceMetaDataResponse{
                success: rsp
              }

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.GetServiceMetaDataResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("prepareXATransaction", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.PrepareXATransactionArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.PrepareXATransactionArgs{
           conn_id: conn_id,
           xid: xid,
           token: token
         }, ""} ->
          try do
            ...
            (
              response = %Thrift.Generated.SnappyDataService.PrepareXATransactionResponse{
                success: rsp
              }

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.PrepareXATransactionResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("executePreparedQuery", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.ExecutePreparedQueryArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.ExecutePreparedQueryArgs{
           stmt_id: stmt_id,
           params: params,
           attrs: attrs,
           token: token
          ...
          try do
            ...
            (
              response = %Thrift.Generated.SnappyDataService.ExecutePreparedQueryResponse{
                success: rsp
              }

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.ExecutePreparedQueryResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("getAllServersWithPreferredServer", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.GetAllServersWithPreferredServerArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.GetAllServersWithPreferredServerArgs{
           server_types: server_types,
           server_groups: server_groups,
           failed_servers: failed_servers
         }, ""} ->
          try do
            ...
            (
              response =
                %Thrift.Generated.SnappyDataService.GetAllServersWithPreferredServerResponse{
                  success: rsp
                }

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.GetAllServersWithPreferredServerResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("sendBlobChunk", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.SendBlobChunkArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.SendBlobChunkArgs{
           chunk: chunk,
           conn_id: conn_id,
           token: token
         }, ""} ->
          try do
            ...
            (
              ...
              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.SendBlobChunkResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("endXATransaction", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.EndXATransactionArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.EndXATransactionArgs{
           conn_id: conn_id,
           xid: xid,
           flags: flags,
           token: token
          ...
          try do
            ...
            error in Thrift.Generated.SnappyException ->
              response = %Thrift.Generated.SnappyDataService.EndXATransactionResponse{
                error: error
              }

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.EndXATransactionResponse.BinaryProtocol.serialize(
                 response
               )}
          end
    ...
    def handle_thrift("rollbackXATransaction", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.RollbackXATransactionArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.RollbackXATransactionArgs{
           conn_id: conn_id,
           xid: xid,
           token: token
         }, ""} ->
          try do
            ...
            error in Thrift.Generated.SnappyException ->
              response = %Thrift.Generated.SnappyDataService.RollbackXATransactionResponse{
                error: error
              }

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.RollbackXATransactionResponse.BinaryProtocol.serialize(
                 response
               )}
          end
    ...
    def handle_thrift("bulkClose", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.BulkCloseArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
    ...
    def handle_thrift("prepareStatement", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.PrepareStatementArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.PrepareStatementArgs{
           conn_id: conn_id,
           sql: sql,
           output_params: output_params,
           attrs: attrs,
          ...
          try do
            ...
            (
              response = %Thrift.Generated.SnappyDataService.PrepareStatementResponse{
                success: rsp
              }

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.PrepareStatementResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("commitXATransaction", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.CommitXATransactionArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.CommitXATransactionArgs{
           conn_id: conn_id,
           xid: xid,
           one_phase: one_phase,
           token: token
          ...
          try do
            ...
            error in Thrift.Generated.SnappyException ->
              response = %Thrift.Generated.SnappyDataService.CommitXATransactionResponse{
                error: error
              }

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.CommitXATransactionResponse.BinaryProtocol.serialize(
                 response
               )}
          end
    ...
    def handle_thrift("executeCursorUpdate", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.ExecuteCursorUpdateArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.ExecuteCursorUpdateArgs{
           cursor_id: cursor_id,
           operations: operations,
           changed_rows: changed_rows,
           changed_columns_list: changed_columns_list,
          ...
          try do
            rsp =
              handler_module.execute_cursor_update(
                cursor_id,
                operations,
                changed_rows,
                changed_columns_list,
            ...
            error in Thrift.Generated.SnappyException ->
              response = %Thrift.Generated.SnappyDataService.ExecuteCursorUpdateResponse{
                error: error
              }

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.ExecuteCursorUpdateResponse.BinaryProtocol.serialize(
                 response
               )}
          end
    ...
    def handle_thrift("setTransactionAttributes", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.SetTransactionAttributesArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.SetTransactionAttributesArgs{
           conn_id: conn_id,
           flags: flags,
           token: token
         }, ""} ->
          try do
            ...
            error in Thrift.Generated.SnappyException ->
              response = %Thrift.Generated.SnappyDataService.SetTransactionAttributesResponse{
                error: error
              }

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.SetTransactionAttributesResponse.BinaryProtocol.serialize(
                 response
               )}
          end
    ...
    def handle_thrift("executePreparedBatch", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.ExecutePreparedBatchArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.ExecutePreparedBatchArgs{
           stmt_id: stmt_id,
           params_batch: params_batch,
           attrs: attrs,
           token: token
          ...
          try do
            ...
            (
              response = %Thrift.Generated.SnappyDataService.ExecutePreparedBatchResponse{
                success: rsp
              }

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.ExecutePreparedBatchResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("freeLob", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.FreeLobArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.FreeLobArgs{
           conn_id: conn_id,
           lob_id: lob_id,
           token: token
         }, ""} ->
          try do
            ...
            error in Thrift.Generated.SnappyException ->
              ...
              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.FreeLobResponse.BinaryProtocol.serialize(
                 response
               )}
          end
    ...
    def handle_thrift("getNextResultSet", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.GetNextResultSetArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.GetNextResultSetArgs{
           cursor_id: cursor_id,
           other_result_set_behaviour: other_result_set_behaviour,
           token: token
         }, ""} ->
          try do
            ...
            (
              response = %Thrift.Generated.SnappyDataService.GetNextResultSetResponse{
                success: rsp
              }

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.GetNextResultSetResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("fetchActiveConnections", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.FetchActiveConnectionsArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.FetchActiveConnectionsArgs{
           conn_id: conn_id,
           token: token
         }, ""} ->
          try do
            ...
            (
              response = %Thrift.Generated.SnappyDataService.FetchActiveConnectionsResponse{
                success: rsp
              }

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.FetchActiveConnectionsResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("closeConnection", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.CloseConnectionArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.CloseConnectionArgs{
           conn_id: conn_id,
           close_socket: close_socket,
           token: token
         }, ""} ->
    ...
    def handle_thrift("execute", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.ExecuteArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.ExecuteArgs{
           conn_id: conn_id,
           sql: sql,
           output_params: output_params,
           attrs: attrs,
          ...
          try do
            ...
            (
              ...
              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.ExecuteResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("executeQuery", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.ExecuteQueryArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.ExecuteQueryArgs{
           conn_id: conn_id,
           sql: sql,
           attrs: attrs,
           token: token
          ...
          try do
            ...
            (
              ...
              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.ExecuteQueryResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("getTransactionAttributes", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.GetTransactionAttributesArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.GetTransactionAttributesArgs{
           conn_id: conn_id,
           token: token
         }, ""} ->
          try do
            ...
            (
              response = %Thrift.Generated.SnappyDataService.GetTransactionAttributesResponse{
                success: rsp
              }

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.GetTransactionAttributesResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("sendClobChunk", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.SendClobChunkArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.SendClobChunkArgs{
           chunk: chunk,
           conn_id: conn_id,
           token: token
         }, ""} ->
          try do
            ...
            (
              ...
              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.SendClobChunkResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("closeResultSet", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.CloseResultSetArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.CloseResultSetArgs{
           cursor_id: cursor_id,
           token: token
         }, ""} ->
          try do
            ...
            error in Thrift.Generated.SnappyException ->
              ...
              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.CloseResultSetResponse.BinaryProtocol.serialize(
                 response
               )}
          end
    ...
    def handle_thrift("executePrepared", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.ExecutePreparedArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.ExecutePreparedArgs{
           stmt_id: stmt_id,
           params: params,
           output_params: output_params,
           attrs: attrs,
          ...
          try do
            ...
            (
              ...
              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.ExecutePreparedResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("closeStatement", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.CloseStatementArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
         ...
         ""} ->
          try do
            ...
            error in Thrift.Generated.SnappyException ->
              ...
              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.CloseStatementResponse.BinaryProtocol.serialize(
                 response
               )}
          end
    ...
    def handle_thrift("commitTransaction", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.CommitTransactionArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.CommitTransactionArgs{
           conn_id: conn_id,
           start_new_transaction: start_new_transaction,
           flags: flags,
           token: token
          ...
          try do
            ...
            error in Thrift.Generated.SnappyException ->
              response = %Thrift.Generated.SnappyDataService.CommitTransactionResponse{
                error: error
              }

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.CommitTransactionResponse.BinaryProtocol.serialize(
                 response
               )}
          end
    ...
    def handle_thrift("prepareAndExecute", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.PrepareAndExecuteArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.PrepareAndExecuteArgs{
           conn_id: conn_id,
           sql: sql,
           params_batch: params_batch,
           output_params: output_params,
          ...
          try do
            rsp =
              handler_module.prepare_and_execute(
                conn_id,
                sql,
                params_batch,
                output_params,
            ...
            (
              response = %Thrift.Generated.SnappyDataService.PrepareAndExecuteResponse{
                success: rsp
              }

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.PrepareAndExecuteResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("forgetXATransaction", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.ForgetXATransactionArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.ForgetXATransactionArgs{
           conn_id: conn_id,
           xid: xid,
           token: token
         }, ""} ->
          try do
            ...
            error in Thrift.Generated.SnappyException ->
              response = %Thrift.Generated.SnappyDataService.ForgetXATransactionResponse{
                error: error
              }

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.ForgetXATransactionResponse.BinaryProtocol.serialize(
                 response
               )}
          end
    ...
    def handle_thrift("getIndexInfo", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.GetIndexInfoArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.GetIndexInfoArgs{
           metadata_args: metadata_args,
           unique: unique,
           approximate: approximate
         }, ""} ->
          try do
            ...
            (
              ...
              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.GetIndexInfoResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("scrollCursor", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.ScrollCursorArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.ScrollCursorArgs{
           cursor_id: cursor_id,
           offset: offset,
           offset_is_absolute: offset_is_absolute,
           fetch_reverse: fetch_reverse,
          ...
          try do
            ...
            (
              ...
              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.ScrollCursorResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("executeUpdate", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.ExecuteUpdateArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.ExecuteUpdateArgs{
           conn_id: conn_id,
           sqls: sqls,
           attrs: attrs,
           token: token
          ...
          try do
            ...
            (
              ...
              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.ExecuteUpdateResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("getBestRowIdentifier", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.GetBestRowIdentifierArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.GetBestRowIdentifierArgs{
           metadata_args: metadata_args,
           scope: scope,
           nullable: nullable
         }, ""} ->
          try do
            ...
            (
              response = %Thrift.Generated.SnappyDataService.GetBestRowIdentifierResponse{
                success: rsp
              }

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.GetBestRowIdentifierResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
    ...
    def handle_thrift("cancelCurrentStatement", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.CancelCurrentStatementArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.CancelCurrentStatementArgs{
           conn_id: conn_id,
           token: token
         }, ""} ->
          try do
            ...
            error in Thrift.Generated.SnappyException ->
              response = %Thrift.Generated.SnappyDataService.CancelCurrentStatementResponse{
                error: error
              }

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.CancelCurrentStatementResponse.BinaryProtocol.serialize(
                 response
               )}
          end
    ...
    def handle_thrift("getSchemaMetaData", binary_data, handler_module) do
      case Elixir.Thrift.Generated.SnappyDataService.GetSchemaMetaDataArgs.BinaryProtocol.deserialize(
             binary_data
           ) do
        {%Thrift.Generated.SnappyDataService.GetSchemaMetaDataArgs{
           schema_call: schema_call,
           metadata_args: metadata_args
         }, ""} ->
          try do
            ...
            (
              response = %Thrift.Generated.SnappyDataService.GetSchemaMetaDataResponse{
                success: rsp
              }

              {:reply,
               Elixir.Thrift.Generated.SnappyDataService.GetSchemaMetaDataResponse.BinaryProtocol.serialize(
                 response
               )}
            )
          catch
