defmodule Thrift.Generated.SnappyException do
  ...
  defmodule BinaryProtocol do
    ...
    def deserialize(binary) do
      deserialize(binary, %Thrift.Generated.SnappyException{})
    end

    defp deserialize(<<0, rest::binary>>, %Thrift.Generated.SnappyException{} = acc) do
      {acc, rest}
    end
    ...
    def serialize(%Thrift.Generated.SnappyException{
          exception_data: exception_data,
          server_info: server_info,
          next_exceptions: next_exceptions
        }) do
      [
        case exception_data do
          nil ->
            raise(
              ...
              "Required field :exception_data on Thrift.Generated.SnappyException must not be nil"
            )

          _ ->
            [
              <<12, 1::16-signed>>
              | Thrift.Generated.SnappyExceptionData.serialize(exception_data)
            ]
        end,
        case server_info do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :server_info on Thrift.Generated.SnappyException must not be nil"
            )

          _ ->
            [<<11, 2::16-signed, byte_size(server_info)::32-signed>> | server_info]
        end,
        case next_exceptions do
          nil ->
            <<>>

          _ ->
            [
              <<15, 3::16-signed, 12, length(next_exceptions)::32-signed>>
              | for e <- next_exceptions do
                  Thrift.Generated.SnappyExceptionData.serialize(e)
                end
            ]
        end
        | <<0>>
