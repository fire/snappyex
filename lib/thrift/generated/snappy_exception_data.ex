defmodule Thrift.Generated.SnappyExceptionData do
  ...
  defmodule BinaryProtocol do
    ...
    def deserialize(binary) do
      deserialize(binary, %Thrift.Generated.SnappyExceptionData{})
    end

    defp deserialize(<<0, rest::binary>>, %Thrift.Generated.SnappyExceptionData{} = acc) do
      {acc, rest}
    end
    ...
    defp deserialize__update_counts(<<element::32-signed, rest::binary>>, [
           list,
           remaining | stack
         ]) do
    ...
    def serialize(%Thrift.Generated.SnappyExceptionData{
          reason: reason,
      ...
      [
        case reason do
          nil ->
            raise(
              ...
              "Required field :reason on Thrift.Generated.SnappyExceptionData must not be nil"
            )
        ...
        case error_code do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :error_code on Thrift.Generated.SnappyExceptionData must not be nil"
            )
        ...
        case update_counts do
          nil ->
            <<>>

          _ ->
            [
              <<15, 4::16-signed, 8, length(update_counts)::32-signed>>
              | for e <- update_counts do
                  <<e::32-signed>>
                end
            ]
        end
