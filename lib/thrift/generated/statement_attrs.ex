defmodule Thrift.Generated.StatementAttrs do
  ...
  defstruct(
    result_set_type: nil,
    updatable: nil,
    hold_cursors_over_commit: nil,
    require_auto_inc_cols: nil,
    auto_inc_columns: nil,
    auto_inc_column_names: nil,
    batch_size: 1024,
    fetch_reverse: nil,
    lob_chunk_size: nil,
    max_rows: nil,
    ...
    poolable: nil,
    do_escape_processing: nil,
    pending_transaction_attrs: nil,
    bucket_ids: nil,
    bucket_ids_table: nil
  )
  ...
  defmodule BinaryProtocol do
    ...
    defp deserialize__auto_inc_column_names(
    ...
    defp deserialize__auto_inc_columns(<<element::32-signed, rest::binary>>, [
           list,
           remaining | stack
         ]) do
    ...
    defp deserialize__pending_transaction_attrs__value(<<0, rest::binary>>, key, [
           map,
           remaining | stack
         ]) do
      deserialize__pending_transaction_attrs__key(rest, [
        Map.put(map, key, false),
        remaining - 1 | stack
      ])
    end

    defp deserialize__pending_transaction_attrs__value(<<1, rest::binary>>, key, [
           map,
           remaining | stack
         ]) do
      deserialize__pending_transaction_attrs__key(rest, [
    ...
    def serialize(%Thrift.Generated.StatementAttrs{
          ...
          auto_inc_columns: auto_inc_columns,
          auto_inc_column_names: auto_inc_column_names,
          batch_size: batch_size,
          fetch_reverse: fetch_reverse,
          lob_chunk_size: lob_chunk_size,
          max_rows: max_rows,
          ...
          poolable: poolable,
          do_escape_processing: do_escape_processing,
          pending_transaction_attrs: pending_transaction_attrs,
          bucket_ids: bucket_ids,
          bucket_ids_table: bucket_ids_table
        }) do
      [
        ...
        case updatable do
          ...
          _ ->
            raise(
              ...
              "Optional boolean field :updatable on Thrift.Generated.StatementAttrs must be true, false, or nil"
            )
        end,
        case hold_cursors_over_commit do
          nil ->
            <<>>
          ...
          _ ->
            raise(
              Thrift.InvalidValueError,
              "Optional boolean field :hold_cursors_over_commit on Thrift.Generated.StatementAttrs must be true, false, or nil"
            )
        end,
        case require_auto_inc_cols do
          nil ->
            <<>>
          ...
          _ ->
            raise(
              Thrift.InvalidValueError,
              "Optional boolean field :require_auto_inc_cols on Thrift.Generated.StatementAttrs must be true, false, or nil"
            )
        end,
        case auto_inc_columns do
          nil ->
            <<>>

          _ ->
            [
              <<15, 5::16-signed, 8, length(auto_inc_columns)::32-signed>>
              | for e <- auto_inc_columns do
                  <<e::32-signed>>
                end
            ]
        end,
        case auto_inc_column_names do
          nil ->
            <<>>

          _ ->
            [
              <<15, 6::16-signed, 11, length(auto_inc_column_names)::32-signed>>
              | for e <- auto_inc_column_names do
        ...
        case fetch_reverse do
          ...
          _ ->
            raise(
              Thrift.InvalidValueError,
              "Optional boolean field :fetch_reverse on Thrift.Generated.StatementAttrs must be true, false, or nil"
            )
        end,
        case lob_chunk_size do
          nil ->
            <<>>
        ...
        case possible_duplicate do
          ...
          _ ->
            raise(
              Thrift.InvalidValueError,
              "Optional boolean field :possible_duplicate on Thrift.Generated.StatementAttrs must be true, false, or nil"
            )
        end,
        case poolable do
          nil ->
          ...
          _ ->
            raise(
              Thrift.InvalidValueError,
              "Optional boolean field :poolable on Thrift.Generated.StatementAttrs must be true, false, or nil"
            )
        end,
        case do_escape_processing do
          nil ->
            <<>>
          ...
          _ ->
            raise(
              Thrift.InvalidValueError,
              "Optional boolean field :do_escape_processing on Thrift.Generated.StatementAttrs must be true, false, or nil"
            )
        end,
        case pending_transaction_attrs do
          nil ->
            <<>>

          _ ->
            [
              <<13, 17::16-signed, 8, 2, Enum.count(pending_transaction_attrs)::32-signed>>
              | for {k, v} <- pending_transaction_attrs do
                  [
                    <<k::32-signed>>
                    | case v do
                        nil ->
        ...
        case bucket_ids do
          ...
          _ ->
            [
              <<14, 18::16-signed, 8, Enum.count(bucket_ids)::32-signed>>
              | for e <- bucket_ids do
                  <<e::32-signed>>
                end
            ]
        end,
        case bucket_ids_table do
          nil ->
            <<>>
