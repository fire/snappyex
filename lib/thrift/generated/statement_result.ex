defmodule(Thrift.Generated.StatementResult) do
  ...
  defmodule(BinaryProtocol) do
    ...
    def(serialize(%Thrift.Generated.StatementResult{result_set: result_set, update_count: update_count, batch_update_counts: batch_update_counts, procedure_out_params: procedure_out_params, generated_keys: generated_keys, new_default_schema: new_default_schema, warnings: warnings, prepared_result: prepared_result})) do
      [case(result_set) do
        nil ->
          <<>>
        _ ->
