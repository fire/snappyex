defmodule Thrift.Generated.TransactionXid do
  ...
  defmodule BinaryProtocol do
    ...
    def deserialize(binary) do
      deserialize(binary, %Thrift.Generated.TransactionXid{})
    end

    defp deserialize(<<0, rest::binary>>, %Thrift.Generated.TransactionXid{} = acc) do
      {acc, rest}
    end
    ...
    def serialize(%Thrift.Generated.TransactionXid{
          format_id: format_id,
          global_id: global_id,
      ...
      [
        case format_id do
          nil ->
            raise(
              ...
              "Required field :format_id on Thrift.Generated.TransactionXid must not be nil"
            )
        ...
        case global_id do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :global_id on Thrift.Generated.TransactionXid must not be nil"
            )

          _ ->
            [<<11, 2::16-signed, byte_size(global_id)::32-signed>> | global_id]
        end,
        case branch_qualifier do
          nil ->
            raise(
              Thrift.InvalidValueError,
              "Required field :branch_qualifier on Thrift.Generated.TransactionXid must not be nil"
            )
