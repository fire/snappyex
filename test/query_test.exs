...
#  require Decimal
  ...
  test "encode basic types", context do
    ...
    assert nil == query("INSERT INTO SNAPPYEX_TEST.TEST_ENCODE (id, title, body, f, d, b, curr) VALUES (?, ?, ?, ?, ?, ?, ?)", [1, "Along came a spider", "This is a book", 42, 42.4242, 1234, DateTime.from_erl({{0000,  12,  30}, {0, 0, 0}}, "Etc/UTC")])
