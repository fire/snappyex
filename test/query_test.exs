...
#  require Decimal
  ...
  test "encode basic types", context do
    ...
    assert nil == query("INSERT INTO SNAPPYEX_TEST.TEST_ENCODE (id, title, body, f, d) VALUES (?, ?, ?, ?, ?)", [1, "Along came a spider", "This is a book", 42, 42.0])
    assert [[1, "Along came a spider", "This is a book", 42.0, 42.0]] == query("SELECT * FROM SNAPPYEX_TEST.TEST_ENCODE", [])
